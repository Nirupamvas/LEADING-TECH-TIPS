...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>LTT | Edit Future Event</title>
        <!-- add icon link -->
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="managefuture.php">
                  <i class="material-icons">view_module</i>
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Edit Future Event</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
...
$sql = "SELECT *FROM future_events WHERE future_id='$eventid'" ;
...
while($event = mysqli_fetch_array($result)) 
{
   ...
   ?>
    ...
    Admin name: 
		<input type="text" id="admin_name" class="form-control" value="<?php echo $_SESSION['username']; ?> "required><br>

    
		Future event:
    <input id="future_event" type="text" class="form-control" value="<?php echo $event['future_event']; ?> " required><br>

     
		Event Place:
    <input id="event_place" type="text" class="form-control" value="<?php echo $event['event_place']; ?> " required><br>
    
		Future Month:
		<input id="future_month" type="text" class="form-control" value="<?php echo $event['future_month']; ?> " required>
		<br>

		Future Day:
		<input id="future_day" type="text" class="form-control" value="<?php echo $event['future_day']; ?> " required>
		<br>
...
<div style="text-align:center" >
		<input type="submit" class="mb-2 btn btn-primary mr-2" id="update" name="submit" value="Update"> </div>
	</form>
...
<script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        $("#update").on("click",function(e){
          ...
          var id="<?php echo $eventid; ?>";
          var a_name=$("#admin_name").val();
          var f_event=$("#future_event").val();
          var e_place=$("#event_place").val();
          var f_month=$("#future_month").val();
          var f_day=$("#future_day").val();

          if (f_event=="" || e_place=="" || f_month=="" || f_day=="") {
        ...
        $.ajax({
          url: "php/editfuture.php",
          type:"POST",
          data:{fid:id,admin_name:a_name,future_event:f_event,event_place:e_place,future_month:f_month,future_day:f_day},
          success:function(data) {

            if(data==1) {
              $("#success-message").html("Event has been updated successfully").slideDown();
               $("#error-message").slideUp();
            
            }

            else {
              $("#error-message").html("Unable to update the event").slideDown();
               $("#success-message").slideUp();
              }
            }
