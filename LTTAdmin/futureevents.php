...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>LTT | Add Future Event</title>
        <!-- add icon link -->
        ...
        <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="futureevents.php">
                  <i class="material-icons">note_add</i>
...
?>
  ...
  ?>
          ...
          <div class="main-content-container container-fluid px-4">
            ...
            <div class="page-header row no-gutters py-4">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Add Future Event</h3>
              </div>
            </div>
            <!-- End Page Header -->
            <div class="row">
    ...
    Admin name: 
		...
		Future event:
    <input id="future_event" type="text" class="form-control" required><br>

     
		Event Place:
    <input id="event_place" type="text" class="form-control" required><br>
    
		Future Month:
		<input id="future_month" type="text" class="form-control" required>
		<br>

		Future Day:
		<input id="future_day" type="text" class="form-control" required>
		<br>


	
<div style="text-align:center" >
		<input type="submit" class="mb-2 btn btn-primary mr-2" id="sub" name="submit" value="Submit"> </div>
	</form>
...
<script type="text/javascript">
      ...
      $(document).ready(function() {
        ...
        $.ajax({
          url: "php/addfuture.php",
          type:"POST",
          data:{admin_name:a_name,future_event:f_event,event_place:e_place,future_month:f_month,future_day:f_day},
          success:function(data) {

            if(data==1) {
              $("#form-data").trigger("reset");  
              $("#success-message").html("Event has been added successfully").slideDown();
              $("#error-message").slideUp();
            }

            else {
              $("#error-message").html("Unable to add the future event").slideDown();
               $("#success-message").slideUp();
            }
          }
