...
?>
  ...
  ?>
		...
		Post Title: 
		<textarea id="post_title" ></textarea><br>

		Post Tag :  
		<input type="text" id="post_tag" ><br> <br>

		Slider Image: <br>
		<textarea  id="slider_img"  ></textarea><br>

		Mini Slider Image: <br>
		<textarea id="mini_slider_img" ></textarea><br>

    Mini Description: <br>
		<textarea id="post_mini_desc" ></textarea><br>



		 Description: 
		<textarea id="post_desc" ></textarea><br>

    <div style="text-align:center">
		<input type="submit" id="submit-click" class="mb-2 btn btn-primary mr-2" value="Submit"></div>
  </form>
...
<script type="text/javascript">
      ...
      $(document).ready(function() {
       ...
       $.ajax({
            url: "php/add.php",
            type:"POST",
            data: {admin_name:a_name,post_cat:p_cat,cat:category,post_title:p_title,post_tag:p_tag,slider_img:image,mini_slider_img:mini_image,post_mini_desc:p_mini_desc,post_desc:p_desc},
            success:function(data) {

              if (data==1) {
                $("#postdata").trigger("reset");  
                CKEDITOR.instances.post_title.setData('');
               CKEDITOR.instances.post_mini_desc.setData('');
               CKEDITOR.instances.post_desc.setData('');
               $("#success-message").html("Post has been added successfully").slideDown();
              ...
              {
                $("#error-message").html("Unable to save the post").slideDown();
               $("#success-message").slideUp();
              }
            }
          });
