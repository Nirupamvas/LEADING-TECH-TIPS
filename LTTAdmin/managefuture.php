          ...
          <!-- / .main-navbar -->
            ...
            <div class="page-header row no-gutters py-4 mb-3 border-bottom">
              <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
                ...
                <h3 class="page-title">Manage Future Events</h3>
              </div>
            </div>
            <!-- End Page Header -->
                    ...
                    <table class="table mb-0">
                      <thead class="bg-light">
                        ...
                        <tr>
                          ...
                          <th scope="col" class="border-0">Future Event</th>
                          <th scope="col" class="border-0">Event Month</th>
                          <th scope="col" class="border-0">Event Day</th>
                      ...
                      $sql = "SELECT *FROM future_events WHERE admin_name= '".$_SESSION['username']."' ORDER BY future_date DESC";
                      ...
                      <tr>
                        <td><?php echo $i ?></td>
                        <td><?php echo $event['future_event'] ?></td>
                        <td><?php echo $event['future_month']; ?></td>
                        <td><?php echo $event['future_day']; ?></td>
                        <td><?php echo $event['event_place']; ?></td>
                        <td><a href="edit_event.php?event_id=<?php echo $event['future_id'];?>" class="mb-2 btn btn-primary mr-2">Edit</a></td>
                        <td><a href="delete_event.php?event_id=<?php echo $event['future_id'];?>" class="mb-2 btn btn-sm btn-danger mr-1">Delete</a></td>
